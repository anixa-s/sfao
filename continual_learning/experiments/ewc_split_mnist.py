...
def ewc_split_mnist(override_args={'epochs': 2}):
    """
    EWC on Split MNIST benchmark with 5 tasks.
    """
    """
    args = create_default_args({'cuda': 0, 'ewc_lambda': 1, 'hidden_size': 512,
                                'hidden_layers': 1, 'epochs': 2, 'dropout': 0,
    ...
    # SplitMNIST with 5 tasks
    benchmark = avl.benchmarks.SplitMNIST(n_experiences=5, return_task_id=True)
