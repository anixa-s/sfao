# experiments/si_split_cifar100.py
...
def si_split_cifar100(override_args=None):
    """
    Train Synaptic Intelligence (SI) on Split CIFAR-100 benchmark.
    """
    ...
    # Benchmark: Split CIFAR-100 into 10 tasks (10 classes each)
    ...
    text_logger = TextLogger(open('si_split_cifar100_log.txt', 'w'))
